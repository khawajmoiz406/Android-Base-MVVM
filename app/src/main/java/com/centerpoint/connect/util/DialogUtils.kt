...
object DialogUtils {
    ...
    fun createSimpleAlertDialog(
        ...
        dialogBuilder.apply {
            ...
            if (messageId is String) setMessage(messageId)
            if (messageId is Int && messageId != -1) setMessage(messageId)
            if (positiveButtonText != -1) setPositiveButton(
                positiveButtonText,
                positiveClickListener
            )
            if (negativeButtonText != -1) setNegativeButton(negativeButtonText, null)
